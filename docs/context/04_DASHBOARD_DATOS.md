# 04_DASHBOARD_DATOS.md — SYNCROSFERA / SynchroShift

Versión: ULTRA PRODUCCIÓN — DATOS / SQL / KPIs / MIGRACIONES
Parte de: `04_MODULE_DASHBOARD.md` (índice) — ver también `04_DASHBOARD_CONTROL.md`
